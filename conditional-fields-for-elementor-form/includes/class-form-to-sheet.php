...
class Sheet_Action extends Form_To_Sheet_Helper
{
    ...
    {
        return esc_html__('Save Submissions in Google Sheet','conditional-fields-for-elementor-form');
    }
    ...
    public function register_settings_section($widget)
    {
        ...
        $widget->start_controls_section(
            ...
            [
                'label' => esc_html__('Save Submissions in Google Sheet','conditional-fields-for-elementor-form'),
            ...
            [
                ...
                'raw'       => '<div class="elementor-control-raw-html cool-form-wrp"><div class="elementor-control-notice elementor-control-notice-type-info">
											...
											<div class="elementor-control-notice-main">
												...
												<button type="button" class="elementor-button e-btn e-info e-btn-1 cfef-install-plugin"  data-plugin="form-db" data-nonce="' . esc_attr(wp_create_nonce('cfef_install_nonce')) . '">Install FormsDB</button>
											</div></div>
											</div></div>',
