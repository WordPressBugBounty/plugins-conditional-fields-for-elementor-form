...
$form_elements = array(
    ...
    'whatsapp_redirect' => array(
        ...
        'how_to' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://coolplugins.net/cool-formkit-for-elementor-forms/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=get-pro&utm_content=plugins-dashboard#pricing'),
    ...
    'toggle_field' => array(
        ...
        'how_to' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://coolplugins.net/cool-formkit-for-elementor-forms/?utm_source=&utm_medium=inside&utm_campaign=get-pro&utm_content=plugins-dashboard#pricing'),
...
$condition_plugin_features = array(
    'condtional_logic' => array(
        ...
        'demo' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=get-pro&utm_content=plugins-dashboard'),
...
$form_mask_features = array(
    'form_input_mask' => array(
        ...
        'how_to' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://docs.coolplugins.net/doc/input-masks-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=demo&utm_content=plugins-dashboard'),
                            ...
                            <div class="cfkef-save-controls">
                                ...
                                if (!$is_condtional_field_active) {
                                    ...
                                    echo '<a target="_blank" href="' . esc_url(
                                        ' https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=' . urlencode($first_plugin) . '&utm_medium=inside&utm_campaign=get-pro&utm_content=plugins-dashboard#pricing'
                        ...
                        <div class="cfk-p-info">
                            ...
                            <div class="cfk-p-name">
                                ...
                                <div class="cfk-buttons">
                                    <a target="_blank" class="button button-secondary" href="https://coolplugins.net/conditional-fields-for-elementor-form/?utm_source=<?php echo $first_plugin; ?>&utm_medium=inside&utm_campaign=demo&utm_content=plugins-dashboard">
                                        Documentation
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="wrapper-body">
                            ...
                            <div class="cfk-p-info">
                                ...
                                <div class="cfk-p-name">
                                    ...
                                    <div class="cfk-buttons">
                                        <a target="_blank" class="button button-secondary" href="https://coolplugins.net/add-input-masks-elementor-form/?utm_source=<?php echo $first_plugin; ?>&utm_medium=inside&utm_campaign=demo&utm_content=plugins-dashboard">
                                            Documentation
                                        </a>
                                    </div>
                                </div>
